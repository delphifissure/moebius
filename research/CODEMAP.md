...
## 31. Sprint 13 (2026-09-12; `S20_thin_lines_and_far_holes.md`)
- **Line-aware despeckle** `window._despeckleLines` (quick bake, the a-series despeckle block, search `S13 (window._despeckleLines)`):
